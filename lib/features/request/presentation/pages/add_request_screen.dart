...
class AddRequestScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: const AddRequestContent(),
    );
  }
}

class AddRequestContent extends StatefulWidget {
  const AddRequestContent({super.key});

  @override
  State<AddRequestContent> createState() => _AddRequestContentState();
}

class _AddRequestContentState extends State<AddRequestContent> {
