...
class _AddDocumentContentState extends State<AddDocumentContent> {
  ...
  final _documentTypesController = TextEditingController();
  final _notesController = TextEditingController();
  final _currentFamilyMembersController = TextEditingController();
  final _currentDocumentTypesController = TextEditingController();
  ...
  @override
  void dispose() {
    _currentDocumentTypesController.dispose();
    _currentDocumentTypesController.dispose();
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildDropdownField(
                          ...
                          items: documentTypes,
                          selectedValue:
                              _currentDocumentTypesController.text.isEmpty
                                  ? null
                                  : _currentDocumentTypesController.text,
                          onChanged: (value) => _currentDocumentTypesController
                              .text = value ?? '',
                        ),
                        SizedBox(height: 6.h),
                        _buildDropdownField(
                          ...
                          items: familyMembers,
                          selectedValue:
                              _currentFamilyMembersController.text.isEmpty
                                  ? null
                                  : _currentFamilyMembersController.text,
                          onChanged: (value) => _currentFamilyMembersController
                              .text = value ?? '',
                        ),
                        SizedBox(height: 6.h),
                        _buildTextField(
      ...
      child: DropdownButtonFormField<String>(
        ...
        items: items.map((item) {
          return DropdownMenuItem<String>(
            ...
            child: Text(
              item,
              style: TextStyle(fontSize: 12.sp, fontFamily: 'Manrope'),
            ),
          );
        }).toList(),
        onChanged: onChanged,
  ...
  Widget _buildSaveButton(DocumentProvider provider) {
    return AnimatedSwitcher(
        ...
        child: provider.isLoading
            ...
            : SizedBox(
                width: 150.w, // Set width
                height: 50.h, // Set height
                child: ElevatedButton(
                  onPressed: provider.hasValidImage
                      ? () => _saveDocument(provider)
                      : null,
